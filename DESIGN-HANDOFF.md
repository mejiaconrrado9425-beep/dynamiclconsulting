# OPEN DISING implementation handoff
...
- `assets/dynamics-logo-mark.png`
- `assets/logo-dynamics-consulting.png`
- `assets/og-dynamics-consulting.jpg`
- `mp7pib7z-LOGO-DYNAMICS-CONSULTING-SIN-FONDO-_1_.png`
- `mp7pir6p-image.png`
- `mpdep57g-LOGO-DYNAMICS-CONSULTING-SIN-FONDO-_1_.png`
